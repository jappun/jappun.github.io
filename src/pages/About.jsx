      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <div className="flex-1 text-primary bg-lighterSky bg-opacity-70 rounded-2xl p-6 md:p-8 font-mont text-lg text-left w-full">
          ...
          <div className="flex items-center justify-start space-x-5 mt-4">
            <a
              href="https://github.com/jappun"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
                className="w-12 h-12 text-primary hover:text-white"
                aria-hidden="true"
            ...
            <a
              href="https://linkedin.com/in/jappun"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
                className="w-14 h-14 fill-primary hover:fill-white"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
